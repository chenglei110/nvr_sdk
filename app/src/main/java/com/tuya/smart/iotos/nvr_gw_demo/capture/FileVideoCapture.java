...
public class FileVideoCapture {
    ...
    public FileVideoCapture(Context context) {
...
//                            continue;
                        ...
                        if (frame_type.equals("I")) {
                            transManager.pushMediaStream(Common.SubDeviceList.IPC_SUB_DEVICE1, Common.ChannelIndex.E_CHANNEL_VIDEO_MAIN, Common.NAL_TYPE.NAL_TYPE_IDR, videoBuffer);
                        } else {
                            transManager.pushMediaStream(Common.SubDeviceList.IPC_SUB_DEVICE1, Common.ChannelIndex.E_CHANNEL_VIDEO_MAIN, Common.NAL_TYPE.NAL_TYPE_PB, videoBuffer);
                        }
